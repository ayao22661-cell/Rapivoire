...
window.PACK_DATA = {
    ...
    UI: {
        ...
        perksFlowDesc: 'Boosts the max quality of your tracks.',
        perksLyricsName: 'Pen Game (Lyrics)',
        perksLyricsDesc: 'Boosts the min quality of your tracks.',
        perksCharismeName: 'Charisma',
        perksCharismeDesc: 'Multiplies the streams you generate every week.',
        perksBizName: 'Business Sense',
        perksBizDesc: 'Cuts your studio and show costs.',

        // ── Share card: career titles (by level) ──
        careerTitleLvl1: 'Hood Hopeful',
        careerTitleLvl2: 'Underground Rapper',
        careerTitleLvl3: 'Rising Artist',
